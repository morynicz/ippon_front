...
@Injectable()
class TestService extends CrudfaService<Resource> {
  constructor(http: HttpClient) {
    super(http, resourcesUrl, filterPrefix, filterSuffix, authorizationUrl);
  }
}

describe('CrudfaService', () => {
  ...
  describe("when isAuthorized is called", () => {
    it("calls the resources api url",
      inject(
        ...
        (service: TestService,
          backend: HttpTestingController) => {
          service.isAuthorized(resource.id).subscribe();
